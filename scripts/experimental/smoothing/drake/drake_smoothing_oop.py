...
class TrajectorySmoother:
    ...
    def apply_task_constraints(self):
        plant = self.drake_util.plant
...
smoother.apply_joint_constraints(lb=0.5*ub,ub=0.5*ub)
# smoother.apply_task_constraints()
