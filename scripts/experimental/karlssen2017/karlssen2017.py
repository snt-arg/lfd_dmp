...
class MyDmp:
    ...
    def controlStep(self,t,ya_new,ya_dot_new):
        ...
        ya_new : current actual position
        ya_dot_new : current actual velocity
        """
        ...
        # Calculate new ya_dd command based on last position, the new velocity feedback, and calculated dmp yd and ydd
...
(xs[0], ys[0], ydots[0], yddots[0]) = dmp.integrateStart(tau*1.5)
t = 0
